"""
Tests for domain/llm.py: AnthropicProvider.
...
def test_anthropic_backend_service_namespace() -> None:
    assert AnthropicProvider._service == "adda-dev:anthropic"
